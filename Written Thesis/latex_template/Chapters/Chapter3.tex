...
Like other simulations in this thesis, an external library of some code was used to speed up the development process.  However, this library features simple methods like finding the distance between two vectors.  These libraries of ``tools'' code are shown in the appendices.  
